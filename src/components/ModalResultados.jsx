...
export default function ModalResultados() {
  ...
  return (
    <div className="flex justify-center items-center">
      ...
      {isOpen && (
        <div
          className="fixed z-50 inset-0 flex justify-items-center items-center justify-center bgBlur"
          onClick={() => setIsOpen(false)}
        >
          <div
            onClick={(e) => e.stopPropagation()}
            className="z-50 fixed bg-slate-800 py-6 rounded-4xl shadow-lg w-[60%] max-lg:w-[90%] h-[90%] max-lg:h-[95%] border-[1px] border-slate-500 flex flex-col justify-between"
          >
            ...
            <div className="text-white p-6 rounded-lg w-full h-full">
              <div className="flex justify-between items-center mb-4">
                <h2 className="text-2xl font-semibold text-orange-300">
                  Processo de Recuperação da Braquioplastia
                </h2>
              </div>
              ...
              <div className="bg-slate-800 p-3 w-full space-y-8 rounded-lg">
                <div className="flex justify-between h-full font-semibold text-gray-300 border-b border-gray-700 pb-2 mb-2">
                  <span>Período</span>
                  <span>Orientações e Evolução</span>
                </div>
                <div className="flex justify-between border-b border-gray-700 py-2 max-lg:text-sm">
                  <span>1-2 semanas</span>
                  <span className="text-right">Uso contínuo da malha compressiva <br /> e repouso relativo</span>
                </div>
                <div className="flex justify-between border-b border-gray-700 py-2 max-lg:text-sm">
                  <span>3-4 semanas</span>
                  <span className="text-right">Retorno gradual às atividades leves</span>
                </div>
                <div className="flex justify-between border-b border-gray-700 py-2 max-lg:text-sm">
                  <span>1-2 meses</span>
                  <span className="text-right">Início da fisioterapia e drenagem linfática</span>
                </div>
                <div className="flex justify-between py-2 max-lg:text-sm">
                  <span>3-6 meses</span>
                  <span className="text-right">Resultados finais visíveis e cicatrização <br /> completa</span>
                </div>
              </div>
